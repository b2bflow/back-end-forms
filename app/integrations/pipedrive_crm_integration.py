...
class PipedriveClient:
    ...
    def update_organization_details(self, org_id: int, segmento: str = None, faturamento: str = None, funcionarios: str = None, produto: str = None):
        data = {}
    ...
    def process_new_lead(self, company_name: str, lead_name: str, motivo_ia: str = "0a605b9668c110080cd956312ac51b11a7855621", email: str = None, phone: str = None):
        """
